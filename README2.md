# resevation<!--ここにアプリ名を入力-->
<!--​READMEを作成する際は、項目内の【補足説明】は削除して完成させてください。-->
## サイト概要
### サイトテーマ
仮想ホテルがイベントや空き部屋の告知を行い、それに対してやりとりが行えるコミュニティサイト
<!-- - 〜なコミュニティサイトorレビューサイトorSNS　と１文で記載する --> 
​
### テーマを選んだ理由
これまでホテルで仕事をしてきましたが、サイトの方にイベントの告知を
詳しく記載したり、それに対するお客様からの問い合わせにお答えする機能がなく不便でしたので
そのサービスが行えれば便利だと思い制作しようと考えました。
